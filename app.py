...
<div style="flex:1;border:1px solid black;background:white;color:black;padding:8px;text-align:center;">
<b>رقم القضية</b><br>
{case_data[6]}
</div>
...
""", unsafe_allow_html=True)
        ...
        st.markdown(f"""
<div dir="rtl" style="border:1px solid black;background:white;color:black;padding:8px;margin-bottom:8px;text-align:center;">
...
<div style="flex:1;border:1px solid black;background:white;color:black;padding:12px;text-align:center;">
<b style="color:#0b3b91;">{case_data[2]}</b>
<br><br>
<span style="color:#c00000;font-weight:bold;font-size:18px;">
{case_data[3]}
</span>
</div>

<div style="flex:1;border:1px solid black;background:white;color:black;padding:12px;text-align:center;">
<b style="color:#0b3b91;">{case_data[4]}</b>
<br><br>
<span style="color:#c00000;font-weight:bold;font-size:18px;">
{case_data[5]}
</span>
...
""", unsafe_allow_html=True)
        ...
        st.markdown(f"""
<div dir="rtl" style="border:1px solid black;background:white;color:black;padding:12px;margin-bottom:8px;">

<div style="text-align:center;font-weight:bold;font-size:20px;color:#0b3b91;">
{subject_title}
</div>
