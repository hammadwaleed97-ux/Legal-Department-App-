...
<div style="flex:1;border:1px solid black;background:white;color:black;padding:8px;">
...
""", unsafe_allow_html=True)
        ...
        st.markdown(f"""
<div dir="rtl" style="border:1px solid black;background:white;color:black;padding:8px;margin-bottom:8px;">
<b>{subject_title}</b>
<hr>
{case_data[13]}
</div>
