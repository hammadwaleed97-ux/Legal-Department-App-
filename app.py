...
# تنسيق CSS المحدث لضمان وضوح النصوص
st.markdown("""
<style>
.stApp { background:#062456; }
label, p, span, div, h1, h2, h3, h4, h5, h6 { color:white !important; }

/* إصلاح ظهور نصوص القوائم المنسدلة */
div[data-baseweb="select"] { background-color: white !important; border: 1px solid #ccc !important; }
div[data-baseweb="select"] div, div[data-baseweb="select"] span { color: black !important; -webkit-text-fill-color: black !important; }
...
if st.session_state.page == "cases":
    ...
    if st.button("💾 حفظ القضية", key="save"):
        cur.execute("INSERT INTO cases VALUES (NULL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'متداولة')",
