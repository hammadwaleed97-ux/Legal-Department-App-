...
if st.session_state.page == "inventory":
    ...
    if not rows:
        ...
        for row in rows:
            ...
            plaintiff = (
                row[8]
                .replace("الهيئة القومية للتأمين الاجتماعى", "الهيئة")
            )
            ...
            if case_type == "دعوى":
                ...
                parties = (
                    f"المستأنف: {plaintiff} × "
                    f"المستأنف ضده: {defendant}"
                )
