...
if st.session_state.page == "deleted":
    ...
    if len(lawsuits) == 0:
        ...
        display_df["رقم القضية"] = lawsuits["case_no"]

        display_df["السنة القضائية"] = lawsuits["judicial_year"]

        display_df["الدائرة"] = lawsuits["circuit"]

        display_df["النوع"] = lawsuits["case_type"]

        display_df["المحكمة"] = lawsuits["court"]

        display_df["اسم المحكمة"] = lawsuits["court_name"]
        ...
        display_df["موضوع القضية"] = lawsuits["subject"]

        display_df["آخر جلسة"] = lawsuits["session_date"]
