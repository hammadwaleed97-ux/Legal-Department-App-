...
# =====================================
# الحصر العام للقضايا (مصحح بالكامل)
# =====================================
    ...
    if not rows:
        ...
        for row in rows:
            ...
            with col1:
                ...
                st.write(
                    f"{safe(row['court'])} • "
                    f"{safe(row['judicial_year'])} • "
                    f"{safe(row['case_type'])} • "
                    f"{safe(row['case_subtype'])} • "
                    f"{safe(row['court_name'])} • "
                    f"{safe(row['case_no'])} • "
                    f"{safe(row['plaintiff'])} ضد {safe(row['defendant'])} • "
                    f"{safe(row['subject'])} • "
                    f"{last_session} • "
                    f"{last_reason}"
                )
            ...
            with col2:
                ...
                if st.button("📂 فتح القضية", key=f"open_{case_id}"):
