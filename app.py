...
# =====================================
    ...
    cases_data = filtered[filtered["status"] == "متداولة"]

    if len(cases_data) == 0:
        st.warning("لا توجد دعاوى خلال الفترة المحددة")
    else:
        for _, r in cases_data.iterrows():
            st.markdown(f"""
---
