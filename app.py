...
<b>القضية رقم:</b> {case_data[6]}/{case_data[7]}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>الدائرة:</b> {case_data[8]}

<br>

<b>النوع:</b> {case_data[9]}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>المحكمة:</b> {case_data[10]} {case_data[11]}
...
<b>{case_data[2]} :</b> {case_data[3]}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>{case_data[4]} :</b> {case_data[5]}
