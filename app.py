...
def create_word_report(
    ...
    # البيانات الصح (خارج header loop تماماً)
    for row in rows:
...
# =====================================
# =====================================
# إنشاء تقرير Word (نسخة محدثة ومقاومة للأخطاء)
# =====================================
...
def create_word_report(
    ...
    # إضافة البيانات مع الحماية من IndexError
    for row in rows:
        cells = table.add_row().cells
        # نستخدم min لضمان عدم تجاوز عدد الخلايا المتاحة في الجدول
