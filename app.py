...
if st.session_state.page == "archive":
    ...
    if not rows:
        ...
        for row in rows:
            ...
            st.write("المدعى:", row[3])
            st.write("المدعى عليه:", row[5])

            st.write("النوع:", row[9])

            st.write("المحكمة:", row[10])
            st.write("اسم المحكمة:", row[11])

            st.write("المأمورية:", row[12])

            st.write("موضوع الدعوى:", row[13])

            st.write("الحكم:", row[20])
...
if st.session_state.page == "update_case":
    ...
    if case_data:
        ...
        st.write("المدعى:", case_data[3])
        st.write("المدعى عليه:", case_data[5])

        st.write("النوع:", case_data[9])
        ...
        st.write("موضوع الدعوى:", case_data[13])
        ...
        if updates:
            ...
            for item in updates:
                ...
                st.write("سبب التأجيل:", item[1])

                st.write("ملاحظات:", item[2])
