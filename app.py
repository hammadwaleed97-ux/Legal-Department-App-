...
if st.session_state.page == "case_details":
    ...
    if not case:
        ...
        st.write(f"**نوع القضية :** {case[1]}")
        st.write(f"**نوع المحكمة :** {case[2]}")
        st.write(f"**المحكمة :** {case[3]}")

        if case[4]:
            st.write(f"**المأمورية :** {case[4]}")

        st.write(f"**رقم القضية :** {case[5]}")
        st.write(f"**السنة القضائية :** {case[6]}")
        st.write(f"**الدائرة :** {case[7]}")
        st.write(f"**التصنيف :** {case[8]}")
        st.write(f"**المدعى :** {case[9]}")
        st.write(f"**المدعى عليه :** {case[10]}")
        st.write(f"**الموضوع :** {case[11]}")
...
# ==========================================================
# ==========================================================
# بداية الجزء الثانى من صفحة تعديل القضية
# ==========================================================
...
# ==========================================================
# ==========================================================
# بداية الجزء الرابع من صفحة تعديل القضية
# ==========================================================
...
# ==========================================================
# ==========================================================
# بداية الجزء الثانى من صفحة إضافة جلسة
# ==========================================================
...
"""
        ...
        st.warning("لا توجد قضايا لإعداد تقرير")
