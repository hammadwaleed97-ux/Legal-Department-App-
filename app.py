...
<div style="margin: 25px 0; font-size: 22px; color: white; line-height: 1.8;">
مع تحيات الإدارة العامة للشئون القانونية<br>
بديوان عام منطقة البحيرة
</div>

<div class="logo-greeting">مع تحيات الإدارة العامة للشئون القانونية<br>بديوان عام منطقة البحيرة</div>
<div class="logo-name">وليد حماد</div>

<div style="margin-top: 25px;">
    <div class="books">
        <div class="book">&#128203; تسجيل القضايا</div>
        <div class="book">&#128193; الحصر العام</div>
        <div class="book">&#128202; التقارير</div>
        <div class="book">&#128276; التنبيهات</div>
        <div class="book">&#128448; الارشيف</div>
        <div class="book">&#128465; حذف القضايا</div>
    </div>
</div>
