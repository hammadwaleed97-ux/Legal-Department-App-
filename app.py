...
st.markdown("---")  # فاصل عن الجزء اللي قبله
    ...
    # =========================
    total = len(filtered)
    judged = len(filtered[filtered["judgment_result"].isin(["لصالح الهيئة", "ضد الهيئة"])])
    ...
    c2.metric("الأحكام الصادرة", judged)
    ...
    cases = filtered[filtered["status"].isin(["متداولة", "محجوزة للحكم"])]
    ...
    def make_pdf():
        ...
        p.drawString(50, y, f"إجمالي القضايا: {total}")
        y -= 30
